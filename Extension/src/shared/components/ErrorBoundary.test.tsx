...
describe('ErrorBoundary', () => {
  ...
  /**
   * Test 9: Reloads page when "Reload Page" is clicked
   */
  ...
  /**
   * Test 10: Opens email client when "Report Issue" is clicked
   */
  it('opens email client when "Report Issue" is clicked', () => {
    const ThrowError = () => {
      throw new Error('Test error');
    };
    ...
    expect(openMock).toHaveBeenCalledWith(
      expect.stringContaining('mailto:support@chatvault.app'),
      '_blank'
    );
  });
  ...
  /**
   * Test 15: Displays friendly error message for storage errors
   */
  it('displays friendly error message for storage errors', () => {
    const ThrowError = () => {
    ...
    expect(screen.getByText(/Storage issue detected/i)).toBeInTheDocument();
  });
...
describe('ErrorBoundary Error Recovery', () => {
  /**
   * Test 17: Recovers from error after retry
   */
  ...
  /**
   * Test 18: Handles multiple consecutive errors
   */
