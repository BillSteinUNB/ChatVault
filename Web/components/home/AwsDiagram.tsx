...
export const AwsDiagram: React.FC = () => {
  const nodes = [
    ...
    { id: 'lambda', label: 'Lambda (Sync/Auth)', x: 450, y: 150, color: '#F472B6' },
    { id: 'dynamo', label: 'DynamoDB (User Data)', x: 650, y: 150, color: '#60A5FA' },
    { id: 's3', label: 'S3 (Backups)', x: 650, y: 250, color: '#FBBF24' },
  ];
